...
import { AnalyseRoutingModule, routedComponents } from './analyse-routing.module';
...
@NgModule({
  imports: [ThemeModule, AnalyseRoutingModule, AngularEchartsModule, NgxChartsModule, ChartModule],
